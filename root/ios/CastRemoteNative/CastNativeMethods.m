...
static NSString *const DEVICE_AVAILABLE = @"CastNativeMethods:DeviceAvailable";
static NSString *const DEVICE_CONNECTED = @"CastNativeMethods:DeviceConnected";
static NSString *const DEVICE_DISCONNECTED = @"CastNativeMethods:DeviceDisconnected";
static NSString *const MEDIA_LOADED = @"CastNativeMethods:MediaLoaded";
